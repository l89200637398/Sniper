...
|----------|----------|----------|
| maxPositions | 14 | Максимум одновременных позиций (совпадает с суммой per-protocol лимитов) |
...
| maxRaydiumCpmmPositions | 3 | CPMM (scalp и обычные позиции делят слоты) |
| maxRaydiumAmmV4Positions | 3 | AMM v4 (scalp и обычные позиции делят слоты) |
