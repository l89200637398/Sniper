...
export const __test_getQueue = (): QueueItem[] => queue;
...
async function processItem(item: QueueItem): Promise<void> {
  ...
  try {
    ...
    logger.debug(`Queue processed: signature=${signature}, tipMultiplier=${item.tipMultiplier}, retries left=${item.retries}`);
